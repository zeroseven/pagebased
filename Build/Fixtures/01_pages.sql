...
--
-- Actual pagebased columns on pages: _pagebased_registration, _pagebased_site, _pagebased_child_object
-- Categories are identified by parent/child (pid) relationship, not a separate column.
--
-- Structure:
--   uid=1   Site Root
